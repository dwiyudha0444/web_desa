            ...
            <div class="container" data-aos="zoom-out">
                ...
                <div class="clients-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><img src="{{ url('client/assets/img/clients/client-1.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ url('client/assets/img/clients/client-2.png') }}"
                                class="img-fluid" alt=""></div>
                        ...
                        <div class="swiper-slide"><img src="{{ url('client/assets/img/clients/client-4.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ url('client/assets/img/clients/client-5.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ url('client/assets/img/clients/client-6.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ url('client/assets/img/clients/client-7.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ url('client/assets/img/clients/client-8.png') }}"
                                class="img-fluid" alt=""></div>
                    </div>
                </div>
                            ...
                            <div class="col-xl-4 col-md-6 portfolio-item filter-app">
                                <div class="portfolio-wrap">
                                    ...
                                    <div class="portfolio-info">
                                        <h4><a href="portfolio-details.html" title="More Details">{{ $ta->judul }}</a></h4>
                                        <p>{{ $ta->keterangan }}r</p>
                                    </div>
                                </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
                        <div class="member">
                            <img src="{{ url('client/assets/img/team/team-1.jpg') }}" class="img-fluid"
                                alt="">
                            <h4>Walter White</h4>
